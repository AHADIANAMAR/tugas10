...
$cases = mysqli_query($koneksi,"select * from statistikcovid"); //mengambil data dari db
while($row = mysqli_fetch_array($cases)){
	$negara[] = $row['country'];
	$query = mysqli_query($koneksi,"SELECT sum(total_cases) as total_cases from statistikcovid where id ='".$row['id']."'");
